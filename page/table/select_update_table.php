...
<body id="page-top">
    ...
    <div class="my-auto">
        <form class=" w-50 h-50 bg-gradient-primary text-white px-5 py-5 coutnform rounded-4 mt-4" id="form_province">
            <input type="hidden" value="<?php echo $rows_select['ta_id'] ?>" id="ta_id">
            <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label">ປະເພດບຸບເຟ້</label>
                <input type="text" class="form-control" id="ta_name" value="<?php echo $rows_select['ta_name'] ?>"
                    aria-describedby="emailHelp">
            </div>
            <div class="mb-3">
                <label for="exampleInputPassword1" class="form-label">ໜາຍເຫດ</label>
                <input type="text" value="<?php echo $rows_select['ta_remak'] ?>" class="form-control" id="ta_remak">
            </div>
            <button type="submit" class="btn btn-primary ">ບັນທືກ</button>
            <button type="reset" class="btn btn-danger ">ລ້າງ</button>
            <a href="select_table.php" class="btn btn-success ">ຂໍ້ມູນ</a>
        </form>
    </div>
