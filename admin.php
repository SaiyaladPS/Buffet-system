        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#type" aria-expanded="true"
                    ...
                    <span>ປະເພດບຸບເຟ້</span>
                </a>
                <div id="type" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">

                        <a class="collapse-item" href="page/type/form_type.php" target="n">ບັນທືກປະເພດບຸບເຟ້</a>
                        <a class="collapse-item" href="page/type/select_type.php" target="n">ຂໍ້ມູນປະເພດບຸບເຟ້</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
                ...
                <div id="table" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="page/table/form_table.php" target="n">ບັນທືກໂຕະ</a>
                        <a class="collapse-item" href="page/table/select_table.php" target="n">ຂໍ້ມູນໂຕະ</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
                ...
                <div id="product" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="page/product/form_product.php" target="n">ບັນທືກສິນຄ້າ</a>
                        <a class="collapse-item" href="page/product/select_product.php" target="n">ຂໍ້ມູນສິນຄ້າ</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#imported"
                    aria-expanded="true" aria-controls="imported">
                    <i class="fas fa-fw fa-cog"></i>
                    <span>ນຳເຂົ້າສິນຄ້າ</span>
                </a>
                <div id="imported" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="page/imported/form_imported.php"
                            target="n">ບັນທືກນຳເຂົ້າສິນຄ້າ</a>
                        <a class="collapse-item" href="page/imported/select_imported.php"
                            target="n">ຂໍ້ມູນນຳເຂົ້າສິນຄ້າ</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
